    ...
    <div class="card-body">
      <form action="/admin/venue/main/update/<?= $venue['id']; ?>" method="post" class="user" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="email" class="form-control form-control-user <?= (session('errors.email') ? 'is-invalid' : ''); ?>" id="email" name="email" value="<?= old('email') ? old('email') : $owner['email']; ?>" placeholder="Email Venue">
            <div class="invalid-feedback">
