...
<section class="py-2">
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form action="/admin/arena/save" method="post" class="user" enctype="multipart/form-data">
        <?= csrf_field(); ?>
        <div class="form-group row">
          <label for="venue_slug" class="col-sm-2 col-form-label">Kode Venue<sup class="text-danger font-weight-bold">*</sup></label>
          <div class="col-sm-10">
            <input type="text" class="form-control form-control-user <?= (session('errors.venue_slug') ? 'is-invalid' : ''); ?>" id="venue_slug" name="venue_slug" value="<?= old('venue_slug') ? old('venue_slug') : ''; ?>" placeholder="Kode Venue">
