...
namespace App\Controllers\Admin\Schedule;
...
class Detail extends BaseController
{
  ...
  public function index()
  {
    $data = [
      ...
      'details'  => $this->scheduleDetailModel->getAllShceduleDetail()->getResultArray(),
    ];
    // dd($data);
    return view('dashboard/admin/schedule/detail/index', $data);
  }
}
