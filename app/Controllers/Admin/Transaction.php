...
class Transaction extends BaseController
{
  ...
  public function index()
  {
    ...
    return view('dashboard/admin/transaction/index', $data);
  }
  public function downpayment()
  {
    ...
    return view('dashboard/admin/transaction/downpayment', $data);
  }
  public function canceled()
  {
    ...
    return view('dashboard/admin/transaction/canceled', $data);
  }
  public function failed()
  {
    ...
    return view('dashboard/admin/transaction/failed', $data);
  }
  ...
  public function detail($transCode)
  {
    ...
    return view('dashboard/admin/transaction/detail', $data);
  }
